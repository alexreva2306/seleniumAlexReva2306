...
public class PracticeWindowHandling {
    ...
    public void multipleWindows () throws InterruptedException {
        ...
        WebElement opMult = driver.findElement(By.xpath("//button[@id='newTabsBtn']"));
        opMult.click();Thread.sleep(300);
        JavascriptExecutor js = (JavascriptExecutor) driver;
        js.executeScript("window,open('https://www.hyrtutorials.com/p/window-handles-practice.html')");
        js.executeScript("window,open('https://www.hyrtutorials.com/p/basic-controls.html')");
        js.executeScript("window,open('https://www.hyrtutorials.com/p/alertsdemo.html')");Thread.sleep(300);
        BrowserUtils.switchByTitle(driver,"\n" + "Basic Controls - \n" + "                H Y R Tutorials");Thread.sleep(300);
        WebElement firstName = driver.findElement(By.xpath("//input[@id='firstName']"));
        firstName.sendKeys("Alex");
        WebElement secName = driver.findElement(By.xpath("//input[@id='lastName']"));
        secName.sendKeys("Reva");
        WebElement gender = driver.findElement(By.xpath("//input[@id='malerb']"));
        gender.click();
        WebElement lang = driver.findElement(By.xpath("//input[@id='englishchbx']"));
        lang.click();
        WebElement email = driver.findElement(By.xpath("//input[@id='email']"));
        email.sendKeys("blabla@gmail.com");
        WebElement password = driver.findElement(By.xpath("//input[@id='password']"));
        password.sendKeys("propoganda");
        WebElement register = driver.findElement(By.xpath("//button[@id='registerbtn']"));
        register.click();Thread.sleep(300);
        WebElement regisSuc = driver.findElement(By.xpath("//label[.='Registration is Successful']"));
        boolean act = regisSuc.isDisplayed();
        boolean exp = true;
        Assert.assertEquals(act,exp);Thread.sleep(1000);

        BrowserUtils.switchByTitle(driver, "AlertsDemo");Thread.sleep(300);
        WebElement clickMe = driver.findElement(By.xpath("//button[@id='alertBox']"));
        clickMe.click();Thread.sleep(300);
        driver.quit();
